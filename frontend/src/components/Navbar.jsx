                    ...
                    <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                        ...
                        {user ? (
                            <div className="mt-4 pt-4 border-t border-white/10 space-y-2">
                                ...
                                <button onClick={() => { handleLogout(); setIsOpen(false); }} className="w-full px-5 py-2 rounded-full border border-white/10 hover:bg-white/5 hover:border-white/20 transition-all duration-300 text-slate-300 hover:text-white font-medium text-sm block text-center cursor-pointer">Sign Out</button>
                            </div>
                        ) : (
                            <Link to="/signin" onClick={() => setIsOpen(false)} className="w-full mt-4 px-5 py-2 rounded-full bg-linear-to-r from-indigo-500 to-purple-600 text-white font-medium text-sm hover:shadow-lg hover:shadow-indigo-500/30 transition-all duration-300 block text-center">Sign In</Link>
                        )}
                    </div>
                </div>
            )}
